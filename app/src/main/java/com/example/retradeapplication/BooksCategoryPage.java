...
public class BooksCategoryPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        btnChat.setOnClickListener(v -> {
            Intent intent = new Intent(BooksCategoryPage.this, ChatPage.class);
            startActivity(intent);
            finish();
        });
    ...
    private void loadProductsFromFirestore() {
        ...
        productsRef.whereEqualTo("category", "Books")
                .addSnapshotListener((value, error) -> {
                    if (error != null) {
                        Toast.makeText(BooksCategoryPage.this, "Error loading products", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    if (productList.isEmpty()) {
                        Toast.makeText(BooksCategoryPage.this, "No clothing products available!", Toast.LENGTH_SHORT).show();
                    }
