...
public class CarsCategoryPage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_cars_category_page);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.cars_category_page), (v, insets) -> {
        ...
        backButton.setOnClickListener(v -> {
            Intent intent = new Intent(CarsCategoryPage.this, HomePageActivity.class);
        ...
        btnSell.setOnClickListener(v -> {
            Intent intent = new Intent(CarsCategoryPage.this, SellingPage.class);
            startActivity(intent);
            finish();
        });
        ...
        btnProfile.setOnClickListener(v -> {
            Intent intent = new Intent(CarsCategoryPage.this, ProfilePage.class);
            startActivity(intent);
            finish();
        });
        ...
        try {
            product1.put("id", "1");
            product1.put("name", "Maruti Suzuki Ertiga");
            product1.put("price", "₹750000");
            product1.put("image", "@drawable/cars_ertiga");
        ...
        try {
            product2.put("id", "2");
            product2.put("name", "Maruti Suzuki Swift");
            product2.put("price", "₹600000");
            product2.put("image", "@drawable/cars_swift");
        } catch (JSONException e) {
            e.printStackTrace();
        }
        ...
        try {
            product3.put("id", "3");
            product3.put("name", "Honda City");
            product3.put("price", "₹1200000");
            product3.put("image", "@drawable/cars_city");
        } catch (JSONException e) {
            e.printStackTrace();
        }
