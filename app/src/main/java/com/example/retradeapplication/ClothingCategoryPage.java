...
public class ClothingCategoryPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.clothing_category_page), (v, insets) -> {
        ...
        contactSellerButton1.setOnClickListener(v -> showContactSellerDialog("+91 1234567890"));
        contactSellerButton2.setOnClickListener(v -> showContactSellerDialog("+91 9876543210"));
        contactSellerButton3.setOnClickListener(v -> showContactSellerDialog("+91 0147852369"));
        ...
        try {
            product1.put("id", "1");
            product1.put("name", "Blue Denim Jeans");
            product1.put("price", "₹1200");
            product1.put("image", "@drawable/clothing_blue_jeans");
        ...
        try {
            product2.put("id", "2");
            product2.put("name", "White Cotton Shirt");
            product2.put("price", "₹600");
            product2.put("image", "@drawable/clothing_white_shirt");
        } catch (JSONException e) {
            e.printStackTrace();
        }
        ...
        try {
            product3.put("id", "3");
            product3.put("name", "Manchester City Jersey");
            product3.put("price", "₹2000");
            product3.put("image", "@drawable/clothing_football_jersey");
        } catch (JSONException e) {
            e.printStackTrace();
        }
