...
public class CollectablesCategoryPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.collectables_category_page), (v, insets) -> {
        ...
        try {
            product1.put("id", "1");
            product1.put("name", "Rare Vintage Car");
            product1.put("price", "₹5000000");
            product1.put("image", "@drawable/collectables_car");
        ...
        try {
            product2.put("id", "2");
            product2.put("name", "1 Rupee Note");
            product2.put("price", "₹600");
            product2.put("image", "@drawable/collectables_note");
        } catch (JSONException e) {
            e.printStackTrace();
        }
        ...
        try {
            product3.put("id", "3");
            product3.put("name", "5 Paise Coin");
            product3.put("price", "₹100");
            product3.put("image", "@drawable/collectables_coin");
        } catch (JSONException e) {
            e.printStackTrace();
        }
