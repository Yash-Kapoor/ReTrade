...
public class ElectronicsCategoryPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChat.setOnClickListener(v -> {
            Intent intent = new Intent(ElectronicsCategoryPage.this, ChatPage.class);
            startActivity(intent);
            finish();
        });
    ...
    private void loadProductsFromFirestore() {
        ...
        productsRef.whereEqualTo("category", "Electronics")
                .addSnapshotListener((value, error) -> {
                    if (error != null) {
                        Toast.makeText(ElectronicsCategoryPage.this, "Error loading products", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    if (productList.isEmpty()) {
                        Toast.makeText(ElectronicsCategoryPage.this, "No clothing products available!", Toast.LENGTH_SHORT).show();
                    }
