...
public class HomeDecorCategoryPage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_home_decor_category_page);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.home_decor_category_page), (v, insets) -> {
        ...
        backButton.setOnClickListener(v -> {
            Intent intent = new Intent(HomeDecorCategoryPage.this, HomePageActivity.class);
        ...
        btnSell.setOnClickListener(v -> {
            Intent intent = new Intent(HomeDecorCategoryPage.this, SellingPage.class);
            startActivity(intent);
            finish();
        });
        ...
        try {
            product1.put("id", "1");
            product1.put("name", "Chandelier");
            product1.put("price", "₹4500");
            product1.put("image", "@drawable/home_decor_chandelier");
        ...
        try {
            product2.put("id", "2");
            product2.put("name", "Peacock Inspired Wall Light");
            product2.put("price", "₹700");
            product2.put("image", "@drawable/home_decor_wall_light");
        } catch (JSONException e) {
            e.printStackTrace();
        }
        ...
        try {
            product3.put("id", "3");
            product3.put("name", "Handcrafted Wall Art");
            product3.put("price", "₹1000");
            product3.put("image", "@drawable/home_decor_wall_art");
        } catch (JSONException e) {
            e.printStackTrace();
        }
