...
public class InstrumentsCategoryPage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_instruments_category_page);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.instruments_category_page), (v, insets) -> {
        ...
        backButton.setOnClickListener(v -> {
            Intent intent = new Intent(InstrumentsCategoryPage.this, HomePageActivity.class);
        ...
        btnSell.setOnClickListener(v -> {
            Intent intent = new Intent(InstrumentsCategoryPage.this, SellingPage.class);
            startActivity(intent);
            finish();
        });
        ...
        btnProfile.setOnClickListener(v -> {
            Intent intent = new Intent(InstrumentsCategoryPage.this, ProfilePage.class);
            startActivity(intent);
            finish();
        });
        ...
        try {
            product1.put("id", "1");
            product1.put("name", "Table");
            product1.put("price", "₹1500");
            product1.put("image", "@drawable/instruments_tabla");
        ...
        try {
            product2.put("id", "2");
            product2.put("name", "Guitar");
            product2.put("price", "₹2500");
            product2.put("image", "@drawable/instruments_guitar");
        } catch (JSONException e) {
            e.printStackTrace();
        }
        ...
        try {
            product3.put("id", "3");
            product3.put("name", "Drums");
            product3.put("price", "₹5500");
            product3.put("image", "@drawable/instruments_drums");
        } catch (JSONException e) {
            e.printStackTrace();
        }
