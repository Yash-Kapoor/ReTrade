...
public class MobilesCategoryPage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_mobiles_category_page);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.mobiles_category_page), (v, insets) -> {
        ...
        backButton.setOnClickListener(v -> {
            Intent intent = new Intent(MobilesCategoryPage.this, HomePageActivity.class);
        ...
        btnSell.setOnClickListener(v -> {
            Intent intent = new Intent(MobilesCategoryPage.this, SellingPage.class);
            startActivity(intent);
            finish();
        });
        ...
        btnProfile.setOnClickListener(v -> {
            Intent intent = new Intent(MobilesCategoryPage.this, ProfilePage.class);
            startActivity(intent);
            finish();
        });
        ...
        try {
            product1.put("id", "1");
            product1.put("name", "OnePlus Nord CE2 Lite");
            product1.put("price", "₹10000");
            product1.put("image", "@drawable/mobiles_oneplus");
        ...
        try {
            product2.put("id", "2");
            product2.put("name", "Iphone 14");
            product2.put("price", "₹30000");
            product2.put("image", "@drawable/mobiles_iphone14");
        } catch (JSONException e) {
            e.printStackTrace();
        }
        ...
        try {
            product3.put("id", "3");
            product3.put("name", "Samsung Galaxy A55");
            product3.put("price", "₹23500");
            product3.put("image", "@drawable/mobiles_galaxy");
        } catch (JSONException e) {
            e.printStackTrace();
        }
