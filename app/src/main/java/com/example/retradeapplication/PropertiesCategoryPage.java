...
public class PropertiesCategoryPage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_properties_category_page);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.properties_category_page), (v, insets) -> {
        ...
        backButton.setOnClickListener(v -> {
            Intent intent = new Intent(PropertiesCategoryPage.this, HomePageActivity.class);
        ...
        btnSell.setOnClickListener(v -> {
            Intent intent = new Intent(PropertiesCategoryPage.this, SellingPage.class);
            startActivity(intent);
            finish();
        });
        ...
        btnProfile.setOnClickListener(v -> {
            Intent intent = new Intent(PropertiesCategoryPage.this, ProfilePage.class);
            startActivity(intent);
            finish();
        });
        ...
        try {
            product1.put("id", "1");
            product1.put("name", "Agricultural Land");
            product1.put("price", "₹4000000");
            product1.put("image", "@drawable/properties_agricultural");
        ...
        try {
            product2.put("id", "2");
            product2.put("name", "Residential Plot");
            product2.put("price", "₹3000000");
            product2.put("image", "@drawable/properties_plot");
        } catch (JSONException e) {
            e.printStackTrace();
        }
