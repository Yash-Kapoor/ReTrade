...
public class SportsEquipmentCategoryPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.sports_equipment_category_page), (v, insets) -> {
        ...
        try {
            product1.put("id", "1");
            product1.put("name", "SG Cricket Bat");
            product1.put("price", "₹4200");
            product1.put("image", "@drawable/sports_equipment_bat");
        ...
        try {
            product2.put("id", "2");
            product2.put("name", "Nike Football Boots");
            product2.put("price", "₹3600");
            product2.put("image", "@drawable/sports_equipment_boots");
        } catch (JSONException e) {
            e.printStackTrace();
        }
