...
public class TwoWheelersCategoryPage extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_two_wheelers_category_page);
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.two_wheelers_category_page), (v, insets) -> {
        ...
        backButton.setOnClickListener(v -> {
            Intent intent = new Intent(TwoWheelersCategoryPage.this, HomePageActivity.class);
        ...
        btnSell.setOnClickListener(v -> {
            Intent intent = new Intent(TwoWheelersCategoryPage.this, SellingPage.class);
            startActivity(intent);
            finish();
        });
        ...
        btnProfile.setOnClickListener(v -> {
            Intent intent = new Intent(TwoWheelersCategoryPage.this, ProfilePage.class);
            startActivity(intent);
            finish();
        });
        ...
        try {
            product1.put("id", "1");
            product1.put("name", "Honda Activa");
            product1.put("price", "₹47000");
            product1.put("image", "@drawable/two_wheelers_activa");
        ...
        try {
            product2.put("id", "2");
            product2.put("name", "OLA S1 Pro");
            product2.put("price", "₹80000");
            product2.put("image", "@drawable/two_wheelers_olas1");
        } catch (JSONException e) {
            e.printStackTrace();
        }
        ...
        try {
            product3.put("id", "3");
            product3.put("name", "Bajaj Pulsar");
            product3.put("price", "₹100000");
            product3.put("image", "@drawable/two_wheelers_pulsar");
        } catch (JSONException e) {
            e.printStackTrace();
        }
